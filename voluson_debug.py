#!/usr/bin/env python3
"""
Script debug kết nối Voluson E10
...
def main():
    """Hàm chính"""
    print("🏥 VOLUSON E10 DEBUG SCRIPT")
    print("=" * 50)
    ...
    if passed == total:
        ...
        print("Kết nối Voluson E10 hoạt động bình thường.")
    else:
        print("\n⚠️ CÓ LỖI KẾT NỐI")
        print("\n🔧 Gợi ý khắc phục:")
        
        if not results.get("Ping", True):
            print("1. Kiểm tra máy Voluson E10 có bật không")
        ...
        if not results.get("Port TCP", True):
            ...
            print("6. Kiểm tra DICOM service trên Voluson")
        
        if not results.get("DICOM Connection", True):
            print("7. Kiểm tra AE Title có khớp không")
            print("8. Kiểm tra DICOM configuration trên Voluson")
